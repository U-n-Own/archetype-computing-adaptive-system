...
parser.add_argument("--n_hid", type=int, default=512, help="Hidden size of reservoir")
...
parser.add_argument("--inp_scaling", type=float, default=0.5, help="Input scaling")
...
# Save results
if args.ron:
    filename = f"CIFAR10_log_RON_{args.topology}{args.resultsuffix}.txt"
elif args.pron:
    filename = f"CIFAR10_log_PRON{args.resultsuffix}.txt"
elif args.mspron:
    filename = f"CIFAR10_log_MSPRON{args.resultsuffix}.txt"
elif args.esn:
    filename = f"CIFAR10_log_ESN{args.resultsuffix}.txt"
elif args.deepron:
    filename = f"CIFAR10_log_DEEPRON{args.resultsuffix}.txt"
else:
    filename = f"CIFAR10_log{args.resultsuffix}.txt"
