...
n_inp = 1
n_out = 9  # OliveOil classes (not used directly in RC pipeline)
...
if args.ron:
    f = open(os.path.join(args.resultroot, f"OliveOil_log_RON_{args.topology}{suffix_ac}{args.resultsuffix}.txt"), "a")
elif args.deepron:
    f = open(os.path.join(args.resultroot, f"OliveOil_log_DeepRON_{args.topology}{suffix_ac}{args.resultsuffix}.txt"), "a")
elif args.pron:
    f = open(os.path.join(args.resultroot, f"OliveOil_log_PRON{suffix_ac}{args.resultsuffix}.txt"), "a")
elif args.mspron:
    f = open(os.path.join(args.resultroot, f"OliveOil_log_MSPRON{suffix_ac}{args.resultsuffix}.txt"), "a")
elif args.esn:
    f = open(os.path.join(args.resultroot, f"OliveOil_log_ESN{suffix_ac}{args.resultsuffix}.txt"), "a")
else:
    raise ValueError("Wrong model choice.")
