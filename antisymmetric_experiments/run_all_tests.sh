...
python antisymmetric_experiments/test_smnist_all_models.py --n_hid 250 --batch_size 2500  --n_layers 10 --trial 1 --skip_baseline_validation
if [ $? -eq 0 ]; then
...
python antisymmetric_experiments/test_npcifar10_all_models.py --n_hid 250 --batch_size 2500 --n_layers 10 --trial 1 --skip_baseline_validation
if [ $? -eq 0 ]; then
...
python antisymmetric_experiments/test_psmnist_all_models.py --n_hid 250 --batch_size 2500 --n_layer 10 --trial 1 --skip_baseline_validation
if [ $? -eq 0 ]; then
